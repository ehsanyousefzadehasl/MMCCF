...
_0x3:
	.DB  0x59,0x6F,0x75,0x73,0x65,0x66,0x7A,0x61
	.DB  0x64,0x65,0x68
_0x0:
	.DB  0x48,0x65,0x6C,0x6C,0x6F,0x20,0x4C,0x43
	.DB  0x44,0x21,0x0
_0x2000003:
	.DB  0x80,0xC0
...
;unsigned char surname[12] = "Yousefzadeh", i = 0;
...
; 0000 0087 // D4 - PORTB Bit 4
; 0000 0088 // D5 - PORTB Bit 5
; 0000 0089 // D6 - PORTB Bit 6
; 0000 008A // D7 - PORTB Bit 7
...
; 0000 0093 lcd_gotoxy(0, 1);
	...
	RCALL _lcd_gotoxy
; 0000 0094 
; 0000 0095 for(i = 0; i <13; i++){
	CLR  R5
_0x6:
	LDI  R30,LOW(13)
	CP   R5,R30
	BRSH _0x7
; 0000 0096     lcd_putchar(surname[i]);
	MOV  R30,R5
	LDI  R31,0
	SUBI R30,LOW(-_surname)
	SBCI R31,HIGH(-_surname)
	LD   R26,Z
	RCALL _lcd_putchar
